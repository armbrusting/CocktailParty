...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Party.cocktaillist'
        db.add_column('parties_party', 'cocktaillist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parties.Cocktaillist'], null=True),
                      keep_default=False)

        # Adding field 'Party.guestlist'
        db.add_column('parties_party', 'guestlist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parties.Guestlist'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Party.cocktaillist'
        db.delete_column('parties_party', 'cocktaillist_id')

        # Deleting field 'Party.guestlist'
        db.delete_column('parties_party', 'guestlist_id')
    ...
    models = {
        ...
        'parties.party': {
            ...
            'cocktaillist': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['parties.Cocktaillist']", 'null': 'True'}),
            'guestlist': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['parties.Guestlist']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '48'})
        },
        'parties.preparation': {
